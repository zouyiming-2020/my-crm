	...
	<script>
		$(function () {
			...
			$("#saveButton").click(function () {
				...
				var noSpaceContent=$.trim(codeContent);
				if(codeContent==""){
					alert("编码不能为空，请重新输入")
				}
...
<body>
	...
	<form class="form-horizontal"id="saveForm" method="post" action="settings/dictionary/type/saveDicType.do" role="form">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<textarea class="form-control"name="description" rows="3" id="description" style="width: 200%;"></textarea>
			</div>
		</div>
	</form>
